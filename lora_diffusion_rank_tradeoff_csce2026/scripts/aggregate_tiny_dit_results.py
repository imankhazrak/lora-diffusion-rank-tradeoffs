#!/usr/bin/env python3
"""Aggregate tiny DiT validation metrics into CSV."""
...
def main():
    ...
    out_csv = project_root / "outputs" / "metrics" / "tiny_dit_results.csv"
    fid_csv = project_root / "outputs" / "metrics" / "tiny_dit_fid_results.csv"
    ...
    print(f"Wrote tiny DiT aggregate metrics: {out_csv}")
